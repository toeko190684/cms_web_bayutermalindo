...
switch($_GET[act]){
  ...
  case "tambahagenda":
    echo "<h2>Tambah Agenda</h2>
          ...
          combotgl1(1,31,'tgl_mulai',$tgl_skrg);
          combobln1(1,12,'bln_mulai',$bln_sekarang);
          combotgl1(2000,$thn_sekarang,'thn_mulai',$thn_sekarang);

    echo "<tr><td>Tgl Selesai</td><td> : ";
          combotgl1(1,31,'tgl_selesai',$tgl_skrg);
          combobln1(1,12,'bln_selesai',$bln_sekarang);
          combotgl1(2000,$thn_sekarang,'thn_selesai',$thn_sekarang);
